        ...
        '$scope', function(scope) {
          ...
          scope.calendar = {
            ...
            offsetMargin: function() {
              return (((new Date(this._year, this._month).getDay() - 1) % 7) * 2.7) + "rem";
            },
